...
// --- CAPTCHA HANDLING ---
function generate_captcha_string_reg($length = 6) { // Nama fungsi dibedakan sedikit
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $profile_picture_path = 'assets/profile_placeholder.png'; // Default profile picture
